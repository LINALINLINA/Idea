...
const INPUT_CHANGED = 'demo/INPUT_CHANGED';
const INPUT_SUBMIT = 'demo/INPUT_SUBMIT';
const LIST_ITEM_CLICK = 'demo/LIST_ITEM_CLICK';
const DELETE_LIST_ITEM = 'demo/DELETE_LIST_ITEM';
